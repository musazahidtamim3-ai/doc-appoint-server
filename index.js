...
async function run() {
     try {
          ...
          if (count === 0) {
               ...
               await doctorsCollection.insertMany(doctorsData);
               console.log("Database seeded with sample doctors data.");
          }
          ...
          console.error("Failed to connect or run the server:", error);
     }
}
